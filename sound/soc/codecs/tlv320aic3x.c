...
static const char * const aic3x_dmic_sample_rate_mux[] = {
	"Disabled", "128", "64", "32" };
static SOC_ENUM_SINGLE_DECL(aic3x_dmic_sample_rate_enum, AIC3X_ASD_INTF_CTRLA, 0,
			    aic3x_dmic_sample_rate_mux);
static const struct snd_kcontrol_new aic3x_dmic_sample_rate_mux_controls =
SOC_DAPM_ENUM("Dmic rate", aic3x_dmic_sample_rate_enum);
...
static const struct snd_soc_dapm_widget aic3x_extra_dapm_widgets[] = {
	 ...
	 * using digital mic.
	 */
	SND_SOC_DAPM_REG(snd_soc_dapm_mic, "GPIO1 dmic modclk",
			 AIC3X_GPIO1_REG, 4, 0xf,
			 AIC3X_GPIO1_FUNC_DIGITAL_MIC_MODCLK,
			 AIC3X_GPIO1_FUNC_DISABLED),
	SND_SOC_DAPM_REG(snd_soc_dapm_mic, "GPIO2 dmic datain",
			 AIC3X_GPIO2_REG, 4, 0xf,
	 ...
	 */
	SND_SOC_DAPM_MUX("DMic Rate", SND_SOC_NOPM, 0, 0,
		&aic3x_dmic_sample_rate_mux_controls),


	SND_SOC_DAPM_PGA("Left Digital Mic", MICBIAS_CTRL, 4, 0, NULL, 0),
	SND_SOC_DAPM_PGA("Right Digital Mic", MICBIAS_CTRL, 5, 0, NULL, 0),
...
static const struct snd_soc_dapm_route intercon_extra[] = {
	...
	{"Left Digital Mic", NULL, "DMICL"},
	{"Right Digital Mic", NULL, "DMICR"},

	{"DMic Rate", "128", "Left Digital Mic"},
	{"DMic Rate", "64", "Left Digital Mic"},
	{"DMic Rate", "32", "Left Digital Mic"},

	{"DMic Rate", "128", "Right Digital Mic"},
	{"DMic Rate", "64", "Right Digital Mic"},
	{"DMic Rate", "32", "Right Digital Mic"},
	...
	{ "GPIO2 dmic datain", NULL, "GPIO1 dmic modclk"},

	{"Left ADC", NULL, "GPIO2 dmic datain"},
	{"Right ADC", NULL, "Left ADC"},
